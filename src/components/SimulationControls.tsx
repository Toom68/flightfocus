        ...
        {phase !== 'ARRIVED' ? (
          <>
            <button
              ...
              className="flex-1 py-2 bg-cabin-accent/20 hover:bg-cabin-accent/30 text-cabin-accent text-xs font-medium rounded-lg transition-colors flex items-center justify-center gap-1"
            >
          ...
          <button
            onClick={stopFlight}
            className="flex-1 py-2 bg-cabin-gold/20 hover:bg-cabin-gold/30 text-cabin-gold text-xs font-medium rounded-lg transition-colors"
          >
            New Flight
          </button>
        )}
